            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'card_name') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($card['card_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($card['image']) { ?>
                    <img src="<?php echo $card['image']; ?>" alt="<?php echo $card['name']; ?>" class="img-thumbnail" />
                    <?php } else { ?>
                    <span class="img-thumbnail list"><i class="fa fa-camera fa-2x"></i></span>
                    <?php } ?></td>
                  <td class="text-left"><?php echo $card['name']; ?></td>
                  <td class="text-left">
                    <?php echo $card['price']; ?></td>
                  <td class="text-right"><?php if ($card['quantity'] <= 0) { ?>
                    <span class="label label-warning"><?php echo $card['quantity']; ?></span>
                    <?php } elseif ($card['quantity'] <= 5) { ?>
                    <span class="label label-danger"><?php echo $card['quantity']; ?></span>
                    <?php } else { ?>
                    <span class="label label-success"><?php echo $card['quantity']; ?></span>
                    <?php } ?></td>
                  <td class="text-left"><?php echo $card['status']; ?></td>
                  <td class="text-right"><a href="<?php echo $card['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=card/card&token=<?php echo $token; ?>';
