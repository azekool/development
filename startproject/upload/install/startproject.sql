...
-- --------------------------------------------------------
--SELECT a.card_name, b.denomination_rate as price,b.defaultprice,b.displayprio,b.defaultsellingprice,b.discount,b.CardsToPull as dailylimit,b.reorderlevel,b.reservestock as stocklevel,b.image_name as image,b.imageBack_name as image_back,b.noimg_name as image_sold,b.description,a.hotline_no,a.mobile_no,a.local_no,a.tarifee_image as tariff_image,a.payphone,0 as cardtype_id,a.printID as print_id,a.IsVAT as isvat  FROM `cards` a LEFT JOIN carddenomination b on a.card_id=b.card_id   
--
-- Tabellenstruktur fÃ¼r Tabelle `oc_card`
--
...
CREATE TABLE IF NOT EXISTS `oc_card` (
  ...
  `displayprio` int(6) unsigned DEFAULT '0',
  `defaultsellingprice` double(18,2) DEFAULT NULL,
  `discount` decimal(10,2) DEFAULT NULL,
  `dailylimit` int(4) DEFAULT NULL,
  `reorderlevel` int(20) NOT NULL DEFAULT '0',
  `stocklevel` bigint(20) NOT NULL DEFAULT '0',
  `image` varchar(50) DEFAULT NULL,
  `image_back` varchar(50) DEFAULT NULL,
  `image_sold` varchar(50) DEFAULT NULL,
  `description` text,
  `dial_no` varchar(64) DEFAULT NULL,
  `instruction` mediumtext,
  `hotline_no` varchar(64) DEFAULT NULL,
  `mobile_no` varchar(64) DEFAULT NULL,
  `local_no` varchar(1024) DEFAULT NULL,
  `tariff_image` varchar(50) DEFAULT NULL,
...
(1, 'Pound Sterling', 'GBP', 'Ã‚Â£', '', '2', 0.61250001, 1, '2014-09-25 14:40:00'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2014-09-25 14:40:00'),
(3, 'Euro', 'EUR', '', 'Ã¢â€šÂ¬', '2', 0.78460002, 1, '2014-09-25 14:40:00');
...
(849, 53, 'DubrovaÃ„ï¿½ko-neretvanska', 'DN', 1),
(850, 53, 'Istarska', 'IS', 1),
(851, 53, 'KarlovaÃ„ï¿½ka', 'KA', 1),
(852, 53, 'KoprivniÃ„ï¿½ko-kriÃ…Â¾evaÃ„ï¿½ka', 'KK', 1),
(853, 53, 'Krapinsko-zagorska', 'KZ', 1),
(854, 53, 'LiÃ„ï¿½ko-senjska', 'LS', 1),
(855, 53, 'MeÃ„â€˜imurska', 'ME', 1),
(856, 53, 'OsjeÃ„ï¿½ko-baranjska', 'OB', 1),
(857, 53, 'PoÃ…Â¾eÃ…Â¡ko-slavonska', 'PS', 1),
(858, 53, 'Primorsko-goranska', 'PG', 1),
(859, 53, 'Ã…Â ibensko-kninska', 'SK', 1),
(860, 53, 'SisaÃ„ï¿½ko-moslavaÃ„ï¿½ka', 'SM', 1),
(861, 53, 'Brodsko-posavska', 'BP', 1),
(862, 53, 'Splitsko-dalmatinska', 'SD', 1),
(863, 53, 'VaraÃ…Â¾dinska', 'VA', 1),
(864, 53, 'VirovitiÃ„ï¿½ko-podravska', 'VP', 1),
(865, 53, 'Vukovarsko-srijemska', 'VS', 1),
(866, 53, 'Zadarska', 'ZA', 1),
(867, 53, 'ZagrebaÃ„ï¿½ka', 'ZG', 1),
...
(899, 56, 'Praha', 'A', 1),
(900, 56, 'StÃ…â„¢edoÃ„ï¿½eskÃƒÂ½', 'S', 1),
(901, 56, 'VysoÃ„ï¿½ina', 'J', 1),
...
(3995, 243, 'North BaÃ„ï¿½ka', '01', 1),
(3996, 243, 'Central Banat', '02', 1),
(3997, 243, 'North Banat', '03', 1),
(3998, 243, 'South Banat', '04', 1),
(3999, 243, 'West BaÃ„ï¿½ka', '05', 1),
(4000, 243, 'South BaÃ„ï¿½ka', '06', 1),
(4001, 243, 'Srem', '07', 1),
(4002, 243, 'MaÃ„ï¿½va', '08', 1),
(4003, 243, 'Kolubara', '09', 1),
(4004, 243, 'Podunavlje', '10', 1),
(4005, 243, 'BraniÃ„ï¿½evo', '11', 1),
(4006, 243, 'Ã…Â umadija', '12', 1),
(4007, 243, 'Pomoravlje', '13', 1),
(4008, 243, 'Bor', '14', 1),
(4009, 243, 'ZajeÃ„ï¿½ar', '15', 1),
...
(4094, 117, 'InÃ„ï¿½ukalna novads', '0801800', 1),
...
(4107, 117, 'KÃ„ï¿½rsava, KÃ„ï¿½rsavas novads', '0681009', 1),
(4108, 117, 'KÃ„ï¿½rsavas novads', '0681000', 1),
(4109, 117, 'KocÃ„â€œnu novads ,bij. Valmieras)', '0960200', 1),
(4110, 117, 'Kokneses novads', '0326100', 1),
(4111, 117, 'KrÃ„ï¿½slava, KrÃ„ï¿½slavas novads', '0600201', 1),
(4112, 117, 'KrÃ„ï¿½slavas novads', '0600202', 1),
...
(4120, 117, 'LielvÃ„ï¿½rde, LielvÃ„ï¿½rdes novads', '0741413', 1),
(4121, 117, 'LielvÃ„ï¿½rdes novads', '0741401', 1),
(4122, 117, 'LiepÃ„ï¿½ja', '0170000', 1),
...
(4127, 117, 'LÃ„Â«vÃ„ï¿½ni, LÃ„Â«vÃ„ï¿½nu novads', '0761211', 1),
(4128, 117, 'LÃ„Â«vÃ„ï¿½nu novads', '0761201', 1),
(4129, 117, 'LubÃ„ï¿½na, LubÃ„ï¿½nas novads', '0701413', 1),
(4130, 117, 'LubÃ„ï¿½nas novads', '0701400', 1),
...
(4137, 117, 'MÃ„ï¿½lpils novads', '0807400', 1),
(4138, 117, 'MÃ„ï¿½rupes novads', '0807600', 1),
...
(4148, 117, 'PÃ„ï¿½rgaujas novads', '0427500', 1),
(4149, 117, 'PÃ„ï¿½vilosta, PÃ„ï¿½vilostas novads', '0641413', 1),
(4150, 117, 'PÃ„ï¿½vilostas novads', '0641401', 1),
...
(4167, 117, 'RugÃ„ï¿½ju novads', '0387500', 1),
(4168, 117, 'RundÃ„ï¿½les novads', '0407700', 1),
...
(4181, 117, 'Seda, StrenÃ„ï¿½u novads', '0941813', 1),
...
(4193, 117, 'StrenÃ„ï¿½i, StrenÃ„ï¿½u novads', '0941817', 1),
(4194, 117, 'StrenÃ„ï¿½u novads', '0941800', 1),
...
(4202, 117, 'ValdemÃ„ï¿½rpils, Talsu novads', '0880217', 1),
(4203, 117, 'Valka, Valkas novads', '0940201', 1),
(4204, 117, 'Valkas novads', '0940200', 1),
(4205, 117, 'Valmiera', '0250000', 1),
(4206, 117, 'VangaÃ…Â¾i, InÃ„ï¿½ukalna novads', '0801817', 1),
(4207, 117, 'VarakÃ„Â¼Ã„ï¿½ni, VarakÃ„Â¼Ã„ï¿½nu novads', '0701817', 1),
(4208, 117, 'VarakÃ„Â¼Ã„ï¿½nu novads', '0701800', 1),
(4209, 117, 'VÃ„ï¿½rkavas novads', '0769101', 1),
...
(4218, 117, 'ViÃ„Â¼Ã„ï¿½ni, ViÃ„Â¼Ã„ï¿½nu novads', '0781817', 1),
(4219, 117, 'ViÃ„Â¼Ã„ï¿½nu novads', '0781800', 1),
